      ...
      <div class="player-podium">
        ${podium.map((p,i) => `
          <div class="player-podium-card player-place-${i+1}">
            ...
            <div class="player-avatar">${esc(String(p.name || "?").trim().slice(0,1).toUpperCase())}</div>
    ...
    <div class="player-table-card">
      ...
      ${list.length ? list.map((p,i) => `
        <div class="player-table-row">
          ...
          <span class="player-name-cell"><span class="player-mini-avatar">${esc(String(p.name || "?").trim().slice(0,1).toUpperCase())}</span><strong>${esc(p.name || "Unbekannt")}</strong></span>
