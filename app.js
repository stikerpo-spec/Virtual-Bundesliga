...
$("addMatch").onclick=()=>{if(!adminLoggedIn){return;}const list=readMatchEditor();list.push({id:`match-${Date.now()}-${Math.random().toString(36).slice(2,8)}`,status:"next",home:"",away:"",kickoff:"",homeScore:0,awayScore:0,minute:"",date:""});matchEditorHtml(list);};
